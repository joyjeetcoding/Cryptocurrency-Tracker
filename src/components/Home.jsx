    ...
    return (
        <div className='relative h-screen bg-gradient-to-tr from-gray-700 via-gray-900 to-black'>
            ...
            <div className='absolute top-[66%] left-[16%] right-[16%]'>
                ...
                <br />
                Made by <u><a href="https://www.linkedin.com/in/joyjeet-mukherjee-48b298206/" target='_blank' rel="noreferrer" className='text-yellow-500 hover:text-green-400'> Joyjeet Mukherjee</a></u>, CSE dept., 2nd year
                </p>
            </div>
        </div>
    )
